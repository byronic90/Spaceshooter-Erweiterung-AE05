...
public abstract class GameObject {
    ...
    public Coordinate getObjectPosition() { return objectPosition; }
    public void setObjectPosition(Coordinate objectPosition) { this.objectPosition = objectPosition; }
    ...
    public void setMovingDistance(double movingDistance) { this.movingDistance = movingDistance; }
    ...
    public void moveGameObject() {
        ...
        if ((objectPosition.getY() > 10 && movingDistance > 0)  || (objectPosition.getY() < 550 && movingDistance < 0)) {
        	objectPosition.setY(objectPosition.getY() + direction.getY() * movingDistance);
        }        
    }
            
    public void makeMove() { moveGameObject(); }
